    ...
    children: [
      ...
      { label: 'STEP 1. · 아이디어 구체화', path: '/workshop/idea' },
      {
        ...
        children: [
          ...
          { label: '예제실습1 직접 실습해보기', path: '/workshop/example/ex-1/practice' },
          { label: '예제 실습 2 · 내용', path: '/workshop/example/ex-2/guide' },
          { label: '예제실습전 사전학습하기', path: '/workshop/example/ex-2' },
          { label: '예제실습2 직접 실습해보기', path: '/workshop/example/ex-2/practice' },
