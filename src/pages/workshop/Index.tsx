import { Clock, Download, FlaskConical, Lightbulb, Rocket } from 'lucide-react';
            ...
            {steps.map((item) => {
              ...
              return (
                <div
                  ...
                  className={[
                    'edu-card p-6 sm:p-7 min-h-[260px] sm:min-h-[290px] flex flex-col text-left',
                    item.highlight
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="font-bold text-lg sm:text-xl text-foreground leading-snug">
                        {item.title}
                      </div>
                    </div>
                  </div>
