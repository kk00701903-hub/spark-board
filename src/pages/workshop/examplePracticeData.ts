...
한국어로 답해 줘.`,
  ...
  },
  {
    ...
    duration: '약 30분',
    summary:
      '예제 실습 1에서 만든 프로그램에 **미리보기 기능을 추가**합니다. "실행" 버튼을 누르기 전에 GUI 창 안에서 엑셀 A열 이름 목록을 미리 확인할 수 있게 됩니다. 이 흐름이 STEP 3.에서 본인 아이디어를 만들 때도 똑같이 사용됩니다.',
    warning:
    ...
    overviewSteps: [
      ...
      {
        action: '**완료 후** — 5문제 이해도 확인 → STEP 3.는 교육 종료 후 각자 진행',
        reason: '오늘 배운 내용을 **짧은 퀴즈**로 점검해요. 내 아이디어 구현(STEP 3.)은 **수업이 끝난 뒤** 각자 시간에 도전합니다.',
      },
    ],
    promptSteps: [
      {
