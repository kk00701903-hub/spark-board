...
## 요청
1. 1~2단계에서 찾은 **문제**와 위 내부 시스템이 어떻게 이어지는지 **3~5문장**으로 정리해 줘.
...
답변은 한국어로 작성해 줘.`,
  ...
  },
  {
    ...
    steps: [
      ...
      '완성된 Canvas는 3단계(내부 시스템)·실습 4(제출 문안)의 재료로 씁니다',
    ],
    prompt: `같은 대화에서 이어서, 1단계에서 찾은 문제를 바탕으로 Lean Canvas를 만들어 줘.
...
전체는 한국어로 작성해 줘.`,
  ...
  {
    title: '3단계: 회사 시스템·업무 프로세스 알려주기',
    icon: '🏢',
    duration: '15분',
    difficulty: '초급',
    steps: [
      '1·2단계와 같은 ChatGPT 창에서 이어서 진행합니다',
  ...
  },
  {
    ...
    difficulty: '중급',
    steps: [
      '3단계 질문에 **짧게라도 답**을 같은 창에 이어 붙입니다',
