...
전체는 한국어로 작성해 줘.`,
  },
  {
    ...
    steps: [
      ...
      '아래 프롬프트에서 **기본 정보**와 **관련 시스템**만 노란 칸에 입력합니다',
      'ChatGPT가 제안 배경·AI 활용 방안·활용 데이터·기대 효과를 알아서 작성해 줍니다',
      '생성된 초안을 읽으며 수치와 표현을 실제 상황에 맞게 다듬습니다',
    ],
    prompt: `아래에 내가 적은 **기본 정보**와 **관련 시스템**만 참고해서, 나머지 항목은 ChatGPT가 합리적으로 채워 넣은 사내 AI 아이디어 제안서 초안을 작성해 줘.

같은 대화에서 앞서 정리한 Lean Canvas·아이디어 내용이 있으면 함께 반영해 줘. 문체는 격식 있는 한국어(합니다/입니다 체)로 통일하고, 각 섹션에 소제목과 글머리 기호를 사용해 줘.
...
위 두 가지와 대화 맥락을 바탕으로, 아래 섹션을 모두 작성해 줘. 빈 칸 없이 구체적으로 써 줘.
